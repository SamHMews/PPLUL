...
The app includes five routines, Bonus, swipe navigation, optional weight/reps/effort, Undo through Completed exercises, manual week archives, history and backup/restore. New reps follow each exercise's prescribed range; historical actuals stay unchanged. Weight set-up supports kg, lb and Unknown.
