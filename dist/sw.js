...
const ASSETS=['./','./index.html','./style.css','./mobile.css','./gestures.js','./reps.js','./feedback.css','./app.js','./model.js','./storage.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
